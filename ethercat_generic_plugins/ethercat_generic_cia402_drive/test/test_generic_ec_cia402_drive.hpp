...
class FriendEcCiA402Drive : public ethercat_generic_plugins::EcCiA402Drive
{
  ...
  FRIEND_TEST(EcCiA402DriveTest, DISABLED_EcWriteRPDOFromCommandInterface);
  FRIEND_TEST(EcCiA402DriveTest, EcWriteRPDODefaultValue);
  // FRIEND_TEST(EcCiA402DriveTest, FaultReset);
  FRIEND_TEST(EcCiA402DriveTest, DISABLED_SwitchModeOfOperation);
  FRIEND_TEST(EcCiA402DriveTest, DISABLED_EcWriteDefaultTargetPosition);
};
